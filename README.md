...
_Popcorn_ est une plateforme open source et (vraiment) sans frais ni commission qui aide les développeur-e-s freelance de Rennes à trouver des projets : [Voir le site](https://popcorn-rennes.github.io/)

Les objectifs de _Popcorn_ pour les développeurs freelances :

- 📈 Etre un canal pour trouver des affaires à Rennes sans commission ni intermédiaire
...
Pour soumettre une suggestion, signaler un bug, demander de l'aide, tu peux aussi tout simplement [ouvrir une issue sur ce repo](https://github.com/popcorn-rennes/popcorn-rennes/issues/new)
...
- _Popcorn_ est réservé aux **développeur·e·s de la région de Rennes**.
